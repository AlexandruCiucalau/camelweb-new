  ...
  return (
    <header className="bg-camel-500 text-white relative lg:h-[768px]">
      ...
      <div className="absolute bottom-15 right-15 flex space-x-5">
        ...
        <button onClick={() => router.push("/iconography")} className="w-8 h-8 rounded-full bg-black/30 backdrop-blur-sm flex items-center justify-center text-white hover:bg-opacity-30 transition-all">
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
